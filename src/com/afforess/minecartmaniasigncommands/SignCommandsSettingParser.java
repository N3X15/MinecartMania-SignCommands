...
public class SignCommandsSettingParser implements SettingParser {
            ...
            for (int idx = 0; idx < list.getLength(); idx++) {
                ...
                if (elementChild.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if ((elementChildValue != null) && (elementChildValue != "")) {
                        ...
                        } else if ((elementChildName == "AnnouncementSignPrefixColor") || (elementChildName == "AnnouncementColor")) {
    ...
    private void debugShowConfigs() {
        ...
        for (final Enumeration<String> ConfigKeys = MinecartManiaWorld.getConfiguration().keys(); ConfigKeys.hasMoreElements();) {
            ...
            final String value = MinecartManiaWorld.getConfigurationValue(temp).toString();
            if ((temp == "AnnouncementSignPrefix") || (temp == "AnnouncementSignPrefixColor") || (temp == "AnnouncementColor") || (temp == "SensorDisabledDelay")) {
    ...
    private static ChatColor parseColor(final String str) {
        for (final ChatColor c : ChatColor.values()) {
